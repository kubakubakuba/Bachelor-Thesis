...
by fast-moving objects. They offer significant advantages, including high dynamic range, low latency,
...
algorithms possible, but it also goes against the main advantage of the event cameras which is the low latency.
