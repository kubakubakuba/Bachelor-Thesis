...
The lens used to obtain the data is a 2.5mm f / 1.6 fisheye lens, with a \ac{FOV} of more than 90 degrees, which can be seen in \reffig{fig:fisheye_lens}.
\begin{figure}[H]
  \centering
...
\begin{figure}[H]
  ...
  \caption{Calibration pattern with 5x7 lattice of UV LEDs, taken with a lens with \ac{FOV} of 280 degrees.}
