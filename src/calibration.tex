...
better contrast and allow for precise localization of the center; unfortunately, they need to be labeled manually in this case. The output can be seen in \reffig{fig:calib_ent}
\begin{figure}[H]
	\centering
